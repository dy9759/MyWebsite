// Bilingual UI copy for the site chrome. Kept in its own module so the
// language provider stays focused on state/context logic. Structural
// parity between zh and en is guarded by site-copy-parity.test.ts.
